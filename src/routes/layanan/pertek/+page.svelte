							...
							>
								...
								<div class="min-w-0">
									...
									>
										...
										<span
											class={`inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-(--line) bg-transparent text-(--muted) transition-transform ${isRowExpanded(rowExpansionKey) ? "rotate-180" : ""}`}
											aria-hidden="true"
										>
											<ChevronDown
												class="h-3 w-3"
