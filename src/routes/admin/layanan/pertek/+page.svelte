		...
		<div class="flex flex-wrap items-center gap-2 sm:gap-3">
			...
			>
				...
				<input
					...
					aria-label="Cari data monitoring Pertek"
				/>
			</form>
				...
				{#if data.result.data.length === 0}
					<tr>
						<td colspan="11" class="px-6 py-12 text-center">
							<p class="text-base font-semibold text-[var(--ink)]">Belum ada data monitoring Pertek.</p>
		...
		<div class="overflow-hidden border-y border-[#d7dee8] bg-transparent md:hidden">
			...
			{#if data.result.data.length === 0}
				<div class="px-2 py-8 text-center">
					<p class="text-sm font-semibold text-slate-600">Belum ada data monitoring Pertek.</p>
