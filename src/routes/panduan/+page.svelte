<svelte:head>
	<title>Panduan | SIKOPLING</title>
	<meta
		name="description"
		content="Halaman dummy panduan SIKOPLING. Konten lengkap akan segera tersedia."
	/>
</svelte:head>
...
<section class="relative overflow-hidden pt-28 pb-14 sm:pt-32 sm:pb-20">
	<div class="page-shell relative">
		<div class="mx-auto max-w-3xl text-center">
			...
			>
				Halaman Panduan (Dummy)
			</h1>
			<p class="mt-4 text-base leading-relaxed text-[var(--muted)] sm:text-lg">
				Halaman ini masih berupa placeholder. Konten panduan layanan SI-KOPLING akan ditambahkan
	...
	<div class="page-shell">
		<div class="mx-auto max-w-3xl rounded-3xl border border-[var(--line)] bg-[var(--surface)] p-6 sm:p-8">
			...
			<p class="mt-3 text-sm leading-relaxed text-[var(--muted)] sm:text-base">
				Konten panduan belum tersedia dan akan diperbarui kemudian.
			</p>
		</div>
	</div>
</section>
