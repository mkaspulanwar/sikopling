...
<section id="beranda" class="relative isolate h-[100svh] min-h-[100svh] overflow-hidden">
	...
	>
		<div class="mx-auto max-w-5xl">
			<h1
				class="font-hero-title text-[clamp(4rem,14vw,8rem)] leading-[0.88] font-black tracking-tight text-white uppercase drop-shadow-[0_10px_26px_rgba(2,6,23,0.52)]"
			>
				SIKOPLING
			</h1>
			<p
				class="font-hero-copy mt-4 text-[clamp(1rem,2.1vw,1.55rem)] leading-relaxed font-medium text-white/95 drop-shadow-[0_8px_22px_rgba(2,6,23,0.45)] sm:mt-5"
			>
